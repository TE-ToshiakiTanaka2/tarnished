...
4. Run final analysis, improvement, cleanup, formatting, build, and tests.
5. Commit any final cleanup changes.
6. Push the branch to `origin`.
7. Create the PR with `gh pr create`; put `Closes #<issue_number>` in the body, not the title.
...
10. If merge was requested and validation passes, squash-merge the PR and delete the source branch.
