...
GitHub Issue creation command for Deno CLI projects. Handles requirement discovery, Issue creation, and implementation sizing.
...
2. **Execute sc:brainstorm** - Use SuperClaude's brainstorm feature to dig deeper into requirements:
   ...
   - Consider Deno CLI UX aspects
3. **Organize requirements** - Structure and summarize discovered requirements

### Phase 2: Implementation Planning

4. **Consider implementation approach** - Propose implementation strategy leveraging Deno's characteristics:
   - Utilize Deno standard library
   - Consider permission model (--allow-*)
...
9. **Set Project fields** - Automatically set Size and Priority (if project-automation.yml exists)
...
- Required permission flags: `--allow-read`, `--allow-write`, etc.
- Planned standard library usage
...
## Size Criteria (Deno CLI Project)
