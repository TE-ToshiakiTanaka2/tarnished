...
import { findProject, findFieldByName } from '../src/project/finder.js';
import { findItemInProject, addItemToProject } from '../src/project/item.js';
...
describe('project/finder', () => {
  describe('findProject', () => {
          ...
          projectV2: {
            ...
            fields: {
              nodes: [
                ...
                { id: 'FIELD_2', name: 'Priority', dataType: 'SINGLE_SELECT', options: [{ id: 'OPT_2', name: 'High' }] },
              ],
            },
          },
        },
      ...
      mockClient.query.mockResolvedValue({
        user: {
          projectV2: {
            ...
            fields: {
              nodes: [
                { id: 'FIELD_1', name: 'Status', dataType: 'SINGLE_SELECT' },
              ],
            },
          },
        },
    ...
    it('should throw error if project not found', async () => {
      ...
      await expect(findProject(mockClient as unknown as GraphQLClient, config)).rejects.toThrow('Project not found');
    });
  });
    ...
    it('should return null if item not found', async () => {
      ...
      mockClient.query.mockResolvedValue({
        node: {
          items: {
            nodes: [
              { id: 'ITEM_1', content: { id: 'ISSUE_456' } },
            ],
            pageInfo: { hasNextPage: false, endCursor: null },
          },
        },
